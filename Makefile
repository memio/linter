...
cs-fix: ## Fixes CS with Swiss Knife and PHP-CS-Fixer
	@$(SWISS_KNIFE) namespace-to-psr-4 spec/Memio/Linter --namespace-root 'spec\\Memio\\Linter\\'
	@$(SWISS_KNIFE) namespace-to-psr-4 src/Memio/Linter --namespace-root 'Memio\\Linter\\'
